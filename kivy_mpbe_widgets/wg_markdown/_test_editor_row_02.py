...
class TestApp(App):
    ...
    def build(self):
        ...
        self.md_editor1 = MarkdownRowTextInputWLabel_OBSOLETO(md_text="# Titulo")
        layout.add_widget(self.md_editor1)
        self.md_editor2 = MarkdownRowTextInputWLabel_OBSOLETO(md_text="**Linea de Prueba:** asdkjfalskjdflaksdf")
