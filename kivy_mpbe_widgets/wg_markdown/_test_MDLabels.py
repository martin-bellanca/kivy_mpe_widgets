...
"""
        ...
        md_text = '**Linea** de Prueba _Markdown_'
        self.md_text_1 = """**Cambia a Linea de Prueba:** _texto_ normal"""
        self.md_text_2 = '## Prueba MDTextLabel'


        ly = BoxLayout(orientation='vertical')

        self.mdt = MDTextLabel(md_text=self.md_text_1, size_hint=(1,1))
        ly.add_widget(self.mdt)

        sep = MDSeparatorLabel()
        ly.add_widget(sep)
    ...
    def on_click_btn(self, touch, keycode, var):
        if self.mdt.md_text == self.md_text_1:
            self.mdt.md_text = self.md_text_2
        else:
            self.mdt.md_text = self.md_text_1
