...
from kivy_mpbe_widgets.wg_labels.image_labels import Image, ImageWText
...
class TestApp(App):
    ...
    def build(self):
        ...
        # Icon 1
        self.ic = ImageWText(text='Icono 1', font_style='error', image_source=IMAGES_PATH +'toolbar-archive-i30.png')
        ...
        # Lista con Ubicacion de la Imagen (image_align)
