...
from kivy_mpbe_widgets.wg_labels.image_labels import ImageLabel
...
class TestApp(App):
    ...
    def build(self):
        ...
        # Icon 1
        ic = ImageLabel(image_source=IMAGES_PATH +'toolbar-archive-i30.png')
        ly.add_widget(ic)
        # Icon 2
        ic = ImageLabel(text='Icono 1', font_style='error', image_source=IMAGES_PATH +'toolbar-add-new-i30.png')
        ly.add_widget(ic)
        # Icon 3
        ic = ImageLabel(text='Icono 1', font_style='error', image_source=IMAGES_PATH +'toolbar-archive-i30.png')
        ly.add_widget(ic)
        # Icon 4
        ic = ImageLabel(text='Icono 1', font_style='error', image_source=IMAGES_PATH +'toolbar-archive-i30.png')
        ly.add_widget(ic)
