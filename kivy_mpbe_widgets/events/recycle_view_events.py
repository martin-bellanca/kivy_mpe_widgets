...
#         super(TouchEventDispatcher, self).__init__(**kwargs)
    ...
    def do_something(self, data, index):
        # when do_something is called, the 'on_test' event will be
        # dispatched with the value
        self.dispatch('on_select_item', data, index)
...
#         super(TouchEventDispatcher, self).__init__(**kwargs)
    ...
    def do_something(self, data, index):
        # when do_something is called, the 'on_test' event will be
        # dispatched with the value
        self.dispatch('on_unselect_item', data, index)

    def on_unselect_item(self, *args):
        pass


class ActivateItemEventDispatcher(EventDispatcher):
    def __init__(self, **kwargs):
        self.register_event_type('on_activate_item')
        EventDispatcher.__init__(self, **kwargs)
#         super(TouchEventDispatcher, self).__init__(**kwargs)
    ...
    def do_something(self, data, index):
        # when do_something is called, the 'on_test' event will be
        # dispatched with the value
        self.dispatch('on_activate_item', data, index)

    def on_activate_item(self, *args):
        pass


class UnActivateItemEventDispatcher(EventDispatcher):
    def __init__(self, **kwargs):
        self.register_event_type('on_unactivate_item')
        EventDispatcher.__init__(self, **kwargs)
#         super(TouchEventDispatcher, self).__init__(**kwargs)
    ...
    def do_something(self, data, index):
        # when do_something is called, the 'on_test' event will be
        # dispatched with the value
        self.dispatch('on_unactivate_item', data, index)

    def on_unactivate_item(self, *args):
        pass
